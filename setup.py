...
setup(
    ...
    install_requires=["pandas>=1.0.0", "psutil>=5.6.6", "dask[dataframe]>=2.10.0", "tqdm>=4.33.0", "ipywidgets>=7.0.0" "cloudpickle>=0.2.2", "parso>0.4.0", "bleach>=3.1.1", "modin[ray]>=0.7.4"],
    classifiers=[],
)
